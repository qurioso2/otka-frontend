  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 py-16">
      <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
        ...
        <form className="space-y-6 hidden">{/* Formularul original ascuns pentru referință */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-800 mb-2">CUI/CIF *</label>
              <input 
                type="text" 
                name="vat_id" 
                required
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-neutral-800 mb-2">Nume Contact *</label>
              <input 
                type="text" 
                name="contact_name" 
                required
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-neutral-800 mb-2">Telefon</label>
              <input 
                type="tel" 
                name="phone" 
                className="w-full rounded-xl border border-neutral-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-neutral-900" 
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-800 mb-2">Tip Activitate</label>
              <select 
                name="business_type" 
                className="w-full rounded-xl border border-neutral-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-neutral-900"
              >
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-800 mb-2">Adresa Completă</label>
            <textarea 
              name="address" 
              rows={3}
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-800 mb-2">Volumul anual aproximativ de achiziții (RON)</label>
            <select 
              name="annual_volume" 
              className="w-full rounded-xl border border-neutral-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-neutral-900"
            >
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-800 mb-2">Motivația colaborării (opțional)</label>
            <textarea 
              name="motivation" 
              rows={4}
              className="w-full rounded-xl border border-neutral-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-neutral-900 resize-none" 
