...
export default async function Admin() {
  ...
  if (!isAdmin) {
    return (
      <div className="mx-auto max-w-2xl px-4 sm:px-6 py-16">
        ...
        <p className="mt-2 text-neutral-600">Nu ai rolul necesar pentru a accesa zona de administrare.</p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-10">
      <h1 className="text-2xl font-semibold">Administrare Produse</h1>
      <p className="mt-2 text-neutral-600 text-sm">Import CSV (col: sku,name,slug,price_public_ttc,price_partner_net,stock_qty,gallery,visible)</p>
      ...
      <div className="mt-10 rounded-2xl border border-neutral-200 bg-white p-4">
        <h2 className="font-medium text-neutral-900">Adăugare rapidă</h2>
        <p className="text-sm text-neutral-600">(în curând) Form pentru adăugare manuală produs.</p>
      </div>
    </div>
  );
}
